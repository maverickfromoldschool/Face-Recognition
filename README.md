To follow this project it is highly recommended you, read the "Readme.MD" file as raw, otherwise you won't get the project structure mentioned in the description.
